...
\begin{figure}[!t]
\centering
\includegraphics[width=0.7\linewidth]{images/fig12.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.6\linewidth]{images/fig17.pdf}
...
Then, the projective point of $P^{rotated}$ on the imaging plane is as follows.
\begin{eqnarray}
